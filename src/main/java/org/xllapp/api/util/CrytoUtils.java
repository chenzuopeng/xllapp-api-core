...
public class CrytoUtils {
	 ...
	 *     
	 *     那么：CrytoUtils.generateSign(new String[]{imsi,imei,app_key,timestamp},timestamp,des3Key)
	 * 
	 * @param signItems
	 * @param timestamp
	 * @param des3Key
	...
	public static String generateSign(String[] signItems, String timestamp, String des3Key) {
		try {
			String md5 = CrytoUtils.md5(signItems);
			String sign = CrytoUtils.encode(des3Key, timestamp, md5);
			return sign;
		} catch (Exception e) {
